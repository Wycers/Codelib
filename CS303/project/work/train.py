...
class TrainPipeline():
    def __init__(self, init_model=None, transfer_model=None):
        ...
        if (init_model is not None) and os.path.exists(init_model + '.index'):
            ...
            self.policy_value_net = PolicyValueNet(self.board_width, self.board_height, block=self.resnet_block,
                                                   init_model=init_model, cuda=True)
            ...
            self.policy_value_net = PolicyValueNet(self.board_width, self.board_height, block=self.resnet_block,
                                                   transfer_model=transfer_model, cuda=True)
        else:
...
if __name__ == '__main__':
    training_pipeline = TrainPipeline(init_model='model/model.model', transfer_model=None)
