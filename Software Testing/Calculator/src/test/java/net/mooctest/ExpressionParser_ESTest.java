...
public class ExpressionParser_ESTest extends ExpressionParser_ESTest_scaffolding {
    ...
    public void test43() throws Throwable {
        ExpressionParser expressionParser0 = new ExpressionParser(12);
        expressionParser0.evaluate("-sin[ 0.5 ]");
        try {
            expressionParser0.evaluate("-sin[ ]");
            fail("Excepting exception: MissingOperandException");
        } catch (Exception e) {
        ...
        try {
            expressionParser0.evaluate("sao[ 1 ]");
            fail("Excepting exception: FunctionNotFoundException");
        } catch (Exception e) {
            System.out.println(e.toString());
            verifyException("net.mooctest.ExpressionParser", e);
        }
        ...
        try {
            expressionParser0.evaluate("s[ sin ]");
            fail("Excepting exception: ExpressionParserException");
        ...
        try {
            expressionParser0.evaluate("sin[ sin ]");
            fail("Excepting exception: ExpressionParserException");
    ...
    public void test44() throws Throwable {
        ExpressionParser expressionParser0 = new ExpressionParser(12);
        expressionParser0.evaluate("a =1");
        expressionParser0.evaluate("a =2");
        expressionParser0.evaluate("<a>+1");

        try {
            expressionParser0.evaluate("<b>");
            fail("Excepting exception: VariableNotFoundException");

        } catch (Exception e) {
            System.out.println(e.toString());
            verifyException("net.mooctest.ExpressionParser", e);
        }
        expressionParser0.evaluate("-(1)");
        try {
            expressionParser0.evaluate("<a>.1");
            fail("Excepting exception: ExpressionParserException");
        ...
        expressionParser0.evaluate("(1 - 2 + 3)");
        try {
            expressionParser0.evaluate("1'1");
            fail("Excepting exception: ExpressionParserException");
        ...
        try {
            expressionParser0.evaluate("(");
            fail("Excepting exception: UnmatchedBracketsException");
