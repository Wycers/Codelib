...
public class Calculator_ESTest extends Calculator_ESTest_scaffolding {
    ...
    public void test12() throws Throwable {
        ExpressionParser expressionParser = new ExpressionParser(12);
        Calculator calculator0 = new Calculator();
        calculator0.expParser = expressionParser;

        calculator0.evaluate("a = 1");
        calculator0.parseCommand("list vars");
        calculator0.evaluate("<a> + 1");
        try {
            calculator0.evaluate("<b> + 1");
            fail("Expecting exception: VariableNotFoundException");
