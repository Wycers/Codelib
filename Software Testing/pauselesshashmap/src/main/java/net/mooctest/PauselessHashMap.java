        ...
        void insertUniqueEquivalentAtHeadOfBucket(Entry<K, V> existingEntry, int bucketIndex) {
            ...
            do {
                ...
                if (!isSynchronous) {
                    ...
                    System.out.println(targetBucketHead);
                    System.out.println(cachedExpectedHeadsArray[bucketIndex]);
                    System.out.print("==>");
                    for (int i = 0; i < cachedExpectedHeadsArray.length; i++) {
                        System.out.print(cachedExpectedHeadsArray[i] + ",");
                    }
                    System.out.println();
