...
//    HAL_GPIO_(GPIOC,GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_8|GPIO_PIN_7|GPIO_PIN_6);
...
//    GPIO_SetBits(GPIOB, GPIO_PIN_All);
    ...
    HAL_GPIO_TogglePin(LCD_LED_GPIO_Port, LCD_LED_Pin);					//点亮背光
	LCD_Clear(WHITE);
}
