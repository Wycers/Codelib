...
{
  "$end", "error", "$undefined", "INT", "ADD", "SUB", "MUL", "DIV", "EQ",
  "$accept", "Quiz", "Exp", "Factor", YY_NULLPTR
};
#endif
...
{
       5,     6,     9,    10,    13,    14,    11,    12,     1,     7,
       8
};

static const yytype_int8 yycheck[] =
{
       6,     7,     4,     5,     9,    10,     5,     6,     3,     0,
       8
};
