...
#
# Generated by export_simulation on Wed Apr 17 09:20:40 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './mux.sh' script.
...
./mux.sh -noclean_files

For more information on the script, please type './mux.sh -help'.
